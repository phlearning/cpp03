...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/13 14:45:48 by pvong             #+#    #+#             */
/*   Updated: 2023/11/13 15:50:09 by pvong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name), _guard(false) {
    ...
    if (SHOWMSG) {
        std::cout << "My ScavTrap constructor called: " << COLOR(this->_name, GREEN) << std::endl;
    }
}
...
ScavTrap::~ScavTrap(void) {
    ...
    if (SHOWMSG) {
        std::cout << "ScavTrap destructor called: " << COLOR(this->_name, RED) << std::endl;
    }
}
