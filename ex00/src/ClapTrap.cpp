...
/*   Updated: 2023/11/14 13:44:07 by pvong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : _name(name), _hp(10), _ep(10), _atk(0) {
    ...
    if (SHOWMSG) {
        std::cout << "My ClapTrap constructor called: " << COLOR(name, GREEN) << std::endl;
    }
    this->_maxHp = this->_hp;
}
...
ClapTrap::~ClapTrap(void) {
    ...
    if (SHOWMSG) {
        std::cout << "ClapTrap destructor called: " << COLOR(this->_name, RED) << std::endl;
    }
}
